                    ...
                    <form>
                        ...
                        <div className="mb-4">
                            <input type="email" className="form-control form-control-lg"
                                placeholder="Email Id" onChange={this.changeEmailId.bind(this)} required />
                        </div>
                        <div className="mb-3">
                            <input type="password" className="form-control form-control-lg"
                                placeholder="Password" onChange={this.changePassword.bind(this)} required />
                        </div>
